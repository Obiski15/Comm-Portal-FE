      ...
      <div className="px-8 py-6">
        <div className="flex items-center justify-between">
          ...
          {/* <div className="flex items-center gap-4">
            <button className="flex items-center gap-2 rounded-full bg-popover px-4 py-2 text-sm  hover:bg-muted">
              ...
              <table className="w-full">
                ...
                <tbody className="divide-y divide-muted/50">
                  ...
                  <tr>
                    ...
                    <td className="whitespace-nowrap px-6 py-4 text-sm">85%</td>
                    <td className="whitespace-nowrap px-6 py-4 text-sm font-medium">
                      <a
                        className="text-primary hover:text-primary/80"
                        href="#"
                  ...
                  <tr>
                    ...
                    <td className="whitespace-nowrap px-6 py-4 text-sm">90%</td>
                    <td className="whitespace-nowrap px-6 py-4 text-sm font-medium">
                      <a
                        className="text-primary hover:text-primary/80"
                        href="#"
